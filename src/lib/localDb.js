...
// FIX: Correctly detect Edge/Worker environments without false positives from Next.js polyfills
// Next.js injects a `caches` API in Node.js, so we check for process instead
