...
export const CLI_TOOLS = {
  ...
  antigravity: {
    ...
    configType: "mitm",
    modelAliases: ["claude-opus-4.6-thinking", "claude-sonnet-4.6-thinking", "gemini-3.1-pro-high", "gemini-3.1-pro-low", "gemini-3-flash", "gpt-oss-120b-medium"],
    defaultModels: [
      { id: "claude-opus-4.6-thinking", name: "Claude Opus 4.6 (Thinking)", alias: "claude-opus-4.6-thinking" },
      { id: "claude-sonnet-4.6-thinking", name: "Claude Sonnet 4.6 (Thinking)", alias: "claude-sonnet-4.6-thinking" },
